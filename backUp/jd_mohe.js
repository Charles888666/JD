...
[task_local]
#热8超级盲盒
1 0,1-23/3 * * * https://raw.githubusercontent.com/l499477004/JD-scripts/master/jd_mohe.js, tag=热8超级盲盒, enabled=true
// Loon
[Script]
cron "1 0,1-23/3 * * *" script-path=https://raw.githubusercontent.com/l499477004/JD-scripts/master/jd_mohe.js,tag=热8超级盲盒
// Surge
热8超级盲盒 = type=cron,cronexp=1 0,1-23/3 * * *,wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/l499477004/JD-scripts/master/jd_mohe.js
 */
...
!(async () => {
  if (!cookie) {
    ...
    if ($.time('yyyy-MM-dd') === '2020-08-19') {
      $.msg($.name, '活动已结束', `请禁用或删除脚本\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\nhttps://github.com/l499477004/JD-scripts\n`, {"open-url": "https://github.com/l499477004/JD-scripts"});
    } else {
