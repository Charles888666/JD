...
活动时间：长期活动
更新地址：https://jdsharedresourcescdn.azureedge.net/jdresource/jd_ms.js
...
============小火箭=========
京东秒秒币 = type=cron,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_ms.js, cronexpr="10 7 * * *", timeout=200, enable=true
 */
const $ = new Env('京东秒秒币');
